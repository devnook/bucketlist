...
routes = [
  ...
  Route(r'/city/<city_name>/activity', handler='async.Activity', name='activity', handler_method="list"),
  Route(r'/city/<city_name>/activity/<activity_id>', handler='async.Activity', name='activity'),
